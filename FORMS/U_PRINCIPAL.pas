...
begin
//ABRE A TELA INFORMAÇÕES DO SISTEMA
...
StatusBar1.Panels[0].Style := psOwnerDraw;
 ...
 //desabilita menu e botão no caso de usuário apoio
 if dm.tipo_usuario='APOIO' then
    ...
    // Mostra msg de atualizações

    Messagedlg('O sistema será atualizado!',mtInformation,[mbOk],0);
...
// A TELA DE PESQUISA SOBRE PÔE A DE CADASTRO OU MOVIMENTO
...
// Statusbar1.Panels[0].Text:='Data e Horas :' +  DateTostr(now) + '  ' + TimeTostr(now);
 Statusbar1.Panels[1].Text:='SEJA BEM VINDO AO SISTEMA Sr(a): ' + dm.usuario;
 Statusbar1.Panels[2].Text:='Tipo de Usuário.. : ' + dm.tipo_usuario;
 Statusbar1.Panels[3].Text:='Banco conectado.. : ' + dm.banco;
 Statusbar1.Panels[4].Text:='Data e Horas :' +  DateTostr(now) + '  ' + TimeTostr(now);
end;
