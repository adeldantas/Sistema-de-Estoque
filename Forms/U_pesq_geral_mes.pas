...
uses
  ...
  FireDAC.Comp.Client, frxClass, frxDBSet, frxExportPDF,
...
type
  TFrm_Pesq_geral_Mes = class(TForm)
    ...
    procedure mk_inicioExit(Sender: TObject);
...
procedure TFrm_Pesq_geral_Mes.FormShow(Sender: TObject);
begin
 rg_opcao.ItemIndex:=0;
end;

procedure TFrm_Pesq_geral_Mes.mk_inicioExit(Sender: TObject);
begin
try
